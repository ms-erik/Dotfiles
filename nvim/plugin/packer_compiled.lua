...
_G.packer_plugins = {
  ["autoclose.nvim"] = {
    loaded = true,
    path = "/home/erik/.local/share/nvim/site/pack/packer/start/autoclose.nvim",
  ...
  ["cmp-vsnip"] = {
    loaded = true,
    path = "/home/erik/.local/share/nvim/site/pack/packer/start/cmp-vsnip",
  ...
  vimtex = {
    loaded = true,
    path = "/home/erik/.local/share/nvim/site/pack/packer/start/vimtex",
